                ...
                Expr::Intrinsic(op, args) => {
                    ...
                    (|| {
                        ...
                        let res = match op {
                            ...
                            Intrinsic::NegReal => Const::Real(-x.real()),
                            _ => return,
                        };
                        *expr = Expr::Const(res);
                    })();
                    ...
                    (|| {
                        ...
                        let res = match op {
                            ...
                            Intrinsic::DivNat => Const::Real(x.nat() as f64 / y.nat() as f64),
                            ...
                            Intrinsic::DivInt => Const::Real(x.int() as f64 / y.int() as f64),
                            ...
                            Intrinsic::AddReal => Const::Real(x.real() + y.real()),
                            Intrinsic::SubReal => Const::Real(x.real() - y.real()),
                            Intrinsic::MulReal => Const::Real(x.real() * y.real()),
                            Intrinsic::DivReal => Const::Real(x.real() as f64 / y.real() as f64),
                            Intrinsic::EqReal => Const::Bool(x.real() == y.real()),
                            Intrinsic::NotEqReal => Const::Bool(x.real() != y.real()),
                            Intrinsic::LessReal => Const::Bool(x.real() > y.real()),
                            Intrinsic::MoreReal => Const::Bool(x.real() < y.real()),
                            Intrinsic::LessEqReal => Const::Bool(x.real() <= y.real()),
                            Intrinsic::MoreEqReal => Const::Bool(x.real() >= y.real()),
